...
For manual execution through the AWS Console Step Functions GUI, use the following payload (which includes `billing_period` for CUR manifest mapping):

```json
{
  "run_id": "manual-run-20260328-abcd",
  "correlation_id": "corr-manual-run-20260328-abcd",
  "account_id": "336805808730",
  "execution_date": "2026-03-28T00:00:00Z",
