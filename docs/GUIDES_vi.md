...
Để chạy thủ công trực tiếp từ giao diện điều khiển AWS Console Step Functions GUI, hãy sử dụng payload sau (đã bao gồm trường `billing_period` dùng cho khớp nối manifest CUR):
